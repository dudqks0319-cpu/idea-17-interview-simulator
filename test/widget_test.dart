...
import 'package:app_17_interview_simulator/app.dart';
import 'package:app_17_interview_simulator/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('면접 시뮬레이터'), findsWidgets);
